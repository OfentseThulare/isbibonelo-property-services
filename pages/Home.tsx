  ...
  return (
    <div className="animate-fadeIn">
      ...
      <section className="relative min-h-[92vh] overflow-hidden flex flex-col">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-ink-900/90 via-ink-900/70 to-ink-900/30"></div>

        {/* Main content */}
        <div className="relative flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center py-20 sm:py-28">
          <div className="w-full max-w-xl">
            <p className="font-mono text-[10px] sm:text-[11px] tracking-[0.2em] text-white/50 uppercase mb-4 sm:mb-6">
              [WELCOME TO ISIBONELO]
            </p>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-white mb-5 sm:mb-6 leading-[1.05]">
              Find Your Next<br />Great Space
            </h1>
            <p className="text-base sm:text-lg text-white/70 mb-8 sm:mb-10 leading-relaxed max-w-md">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8 sm:mb-12">
              <Button
                ...
                className="shadow-xl shadow-brand-600/20 w-full sm:w-auto"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-white/30 text-white bg-white/10 hover:bg-white/20 backdrop-blur-sm w-full sm:w-auto"
                onClick={() => trackFunnelClick('B', 'hero')}
              >
                Leasing Enquiries
              </Button>
            </div>
            {/* Search widget — hidden on xs, shown sm+ */}
            <div className="hidden sm:flex bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 items-center gap-3 max-w-md">
              <svg className="w-4 h-4 text-white/50 shrink-0 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Floating agent card — desktop only */}
          <div className="hidden xl:block absolute right-8 bottom-28">
            <Link to="/contact">
              <div className="bg-surface-50 rounded-2xl p-4 flex items-center gap-4 shadow-2xl hover:-translate-y-1 transition-all cursor-pointer max-w-xs">
                <div className="w-11 h-11 rounded-full overflow-hidden shrink-0 border-2 border-brand-600/20">
                  <img
        ...
        {/* Proof bar */}
        <div className="relative bg-white/10 backdrop-blur-md border-t border-white/10 py-4 sm:py-5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={item.label} className="text-center">
                <span className="block text-white font-bold font-heading text-base sm:text-xl">{item.value}</span>
                <span className="text-white/50 font-mono text-[9px] sm:text-[10px] uppercase tracking-widest">{item.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 sm:py-24 bg-surface-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 sm:mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-ink-900">Our Commitment to You</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 mb-4 sm:mb-6">
            {/* Dark image card */}
            <div className="relative rounded-card overflow-hidden min-h-[260px] sm:min-h-[300px]">
              <img
              ...
              <div className="relative h-full flex flex-col justify-between p-6 sm:p-8 min-h-[260px] sm:min-h-[300px]">
                <p className="text-white/60 text-sm max-w-xs leading-relaxed">
                  Managing a diverse portfolio of landmark developments with care and expertise
                </p>
                <div>
                  <span className="block text-white font-bold font-heading text-6xl sm:text-7xl md:text-8xl leading-none">300+</span>
            ...
            {/* Light stat card */}
            <div className="bg-white rounded-card p-6 sm:p-8 flex flex-col justify-between min-h-[260px] sm:min-h-[300px] border border-border-200">
              ...
              <div>
                <span className="block text-ink-900 font-bold font-heading text-6xl sm:text-7xl md:text-8xl leading-none">25</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div key={pillar.title} className="bg-white rounded-card p-5 sm:p-6 border border-border-200">
                <h4 className="font-bold text-ink-900 mb-2 font-heading text-sm sm:text-base">{pillar.title}</h4>
                <p className="text-xs sm:text-sm text-ink-700 leading-relaxed">{pillar.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 sm:mb-12 gap-4">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-ink-900">Strategic Property Solutions</h2>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {SERVICES.map((service, idx) => (
              <div key={service.id} className="bg-surface-50 p-5 sm:p-6 rounded-card border border-border-200 hover:shadow-lg hover:border-brand-600/20 transition-all group">
                <div className="w-10 h-10 bg-brand-600/10 rounded-lg flex items-center justify-center mb-4 sm:mb-5 group-hover:bg-brand-600 transition-colors">
                  <span className="text-brand-600 font-bold font-mono text-xs group-hover:text-white transition-colors">0{idx + 1}</span>
                </div>
                <h3 className="font-bold text-ink-900 mb-2 sm:mb-3 text-sm leading-tight font-heading">{service.title}</h3>
                <p className="text-xs text-ink-700 mb-4 sm:mb-5 leading-relaxed">{service.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 sm:mb-12 gap-4">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white">Landmark Developments</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 sm:gap-6">
            {PORTFOLIO.map(item => (
              <div key={item.id} className="group cursor-pointer">
                <div className="relative aspect-[4/3] overflow-hidden rounded-card mb-3 sm:mb-4">
                  <img
                    src={item.image}
                    alt={item.title}
                  ...
                  <div className="absolute top-3 left-3 sm:top-4 sm:left-4 flex flex-wrap gap-1.5 sm:gap-2">
                    {item.tags.slice(0, 2).map(tag => (
                      <span key={tag} className="bg-brand-600/90 text-white px-2 sm:px-2.5 py-1 rounded-pill text-[9px] sm:text-[10px] font-bold uppercase tracking-widest">
                        {tag}
                      </span>
                    ))}
                  </div>
                </div>
                <h3 className="font-bold text-white font-heading text-sm sm:text-base group-hover:text-brand-600 transition-colors">{item.title}</h3>
                <p className="text-white/40 text-xs sm:text-sm mt-1">{item.location}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── FIT FINDER QUIZ ── */}
      <section id="fit-finder" className="py-16 sm:py-24 bg-surface-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            <div>
              <p className="font-mono text-[11px] tracking-[0.2em] text-ink-700/50 uppercase mb-3">[START YOUR JOURNEY]</p>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-ink-900 mb-5 sm:mb-6">
                Let's Find Your<br/>Ideal Space
              </h2>
              <p className="text-base sm:text-lg text-ink-700 mb-6 sm:mb-8 leading-relaxed">
                Whether you are a private owner, government stakeholder, or a business looking for space, our Fit Finder maps your needs to our expert solutions in under 90 seconds.
              </p>
              ...
              <div className="bg-white rounded-card border border-border-200 p-3 sm:p-4 flex items-center gap-3 sm:gap-4 max-w-sm">
                <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full overflow-hidden shrink-0">
                  <img
                    src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&w=100&h=100&fit=crop&q=80"
                    alt="Property specialist"
                    className="w-full h-full object-cover"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-ink-700/60 truncate">Get personalised property advice</p>
                </div>
                <Link to="/contact">
                  <button className="w-8 h-8 rounded-full bg-surface-50 border border-border-200 flex items-center justify-center text-ink-900 hover:bg-brand-600 hover:text-white hover:border-brand-600 transition-all text-sm shrink-0">
                    →
                  </button>
                </Link>
              </div>
      ...
      <section className="py-16 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 sm:mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-ink-900">Trusted by Our Community</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-8 items-stretch">
            {/* Portrait photo — shorter on mobile */}
            <div className="relative rounded-card overflow-hidden min-h-[300px] sm:min-h-[420px] md:min-h-[480px]">
              <img
                src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&w=700&h=875&fit=crop&q=80"
                alt="Client testimonial"
                className="absolute inset-0 w-full h-full object-cover"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-ink-900/80 via-ink-900/30 to-transparent p-5 sm:p-6">
            ...
            {/* Quote */}
            <div className="bg-surface-50 rounded-card p-7 sm:p-10 flex flex-col justify-between">
              <div>
                <p className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-ink-900 leading-tight mb-6 sm:mb-8">
              ...
              <div className="flex items-center gap-3 mt-6 sm:mt-8">
                <div className="w-8 h-8 bg-brand-600/10 rounded-full flex items-center justify-center shrink-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 sm:mb-12 gap-4">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-ink-900">Updates, Tips & Living Well</h2>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5">
            {BLOG_POSTS.map(post => (
              <div key={post.id} className="bg-white rounded-card border border-border-200 p-5 sm:p-6 hover:shadow-md transition-all flex flex-col">
                ...
                <h4 className="font-bold text-ink-900 font-heading text-base sm:text-lg mb-3 leading-tight flex-1">{post.title}</h4>
                <p className="text-sm text-ink-700 mb-5 sm:mb-6 leading-relaxed">{post.excerpt}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-heading font-bold text-white mb-5 sm:mb-6">
                Mthethwa Family Development Foundation
              </h2>
              <p className="text-white/60 text-base sm:text-lg mb-7 sm:mb-8 leading-relaxed">
      ...
      <section className="py-16 sm:py-24 bg-surface-50">
        <div className="max-w-2xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-card border border-border-200 p-8 sm:p-12 text-center shadow-xl">
            <p className="font-mono text-[11px] tracking-[0.2em] text-ink-700/50 uppercase mb-4">[GET STARTED]</p>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-ink-900 mb-4">
              Let's Build the Future Together
            </h2>
            <p className="text-ink-700 mb-7 sm:mb-8 max-w-sm mx-auto text-sm leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link to="/contact" className="w-full sm:w-auto">
                <div className="bg-surface-50 border border-border-200 rounded-card px-4 py-3 flex items-center gap-3 hover:border-brand-600/30 hover:shadow-md transition-all cursor-pointer">
                  ...
                  <span className="text-sm font-medium text-ink-900 whitespace-nowrap">Talk to an Agent →</span>
                </div>
              </Link>
            </div>
          </div>
