    ...
    <div className="animate-fadeIn">
      ...
      <section className="relative bg-ink-900 py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-5xl md:text-6xl font-heading font-bold text-white mb-4">Our Indelible Fingerprint</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-4xl font-heading font-bold text-ink-900 mb-6">Built on Trust and Partnership</h2>
      ...
      <section className="py-24 bg-ink-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="font-mono text-[11px] tracking-[0.2em] text-white/40 uppercase mb-4">[LEADERSHIP]</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-5xl">
            <div className="relative rounded-card overflow-hidden aspect-[3/4]">
              <img
                src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&w=600&h=800&fit=crop&q=80"
                alt="Shadrack Mthethwa — Founder & CEO"
                className="w-full h-full object-cover grayscale"
              />
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-ink-900/90 p-6">
                <p className="text-white font-bold font-heading text-xl">Shadrack Mthethwa</p>
                <p className="font-mono text-white/50 text-[10px] uppercase tracking-widest">Founder & CEO</p>
              </div>
            </div>
            <div>
              <span className="font-mono text-[11px] tracking-[0.2em] text-brand-600 uppercase block mb-4">Our Founder & CEO</span>
              <h2 className="text-4xl font-heading font-bold text-white mb-4">Shadrack Mthethwa</h2>
              <div className="bg-brand-600/10 border-l-4 border-brand-600 p-4 mb-6 rounded-r-lg">
      ...
      <section className="py-24 bg-surface-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-heading font-bold text-ink-900">Strategic Focus Areas</h2>
            <p className="text-ink-700 mt-3 max-w-xl mx-auto">Where we focus our expertise to drive maximum community and commercial value.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={focus.title} className="bg-white p-8 rounded-card border border-border-200 hover:border-brand-600/30 hover:shadow-md transition-all">
                <span className="font-mono text-brand-600 text-sm font-bold block mb-4">{focus.number}</span>
                <h3 className="font-bold font-heading text-ink-900 mb-3">{focus.title}</h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="text-4xl font-heading font-bold text-ink-900 mb-6">Community Impact via MFDF</h2>
              <p className="text-ink-700 mb-8 leading-relaxed text-lg">
              ...
              <div className="space-y-5">
                <div className="flex gap-4 items-start">
                  <div className="w-11 h-11 bg-surface-50 rounded-card flex items-center justify-center border border-border-200 shrink-0 text-xl">📚</div>
                  <div>
      ...
      <section className="py-24 bg-surface-50 text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <h2 className="text-4xl font-heading font-bold text-ink-900 mb-4">Partner with us for your next development</h2>
          <p className="text-ink-700 mb-8 leading-relaxed">Ready to create something that leaves an indelible fingerprint?</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact"><Button size="lg">Request Consultation</Button></Link>
            <Link to="/services"><Button size="lg" variant="secondary">Browse Services</Button></Link>
          </div>
        </div>
      </section>
